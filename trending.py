...
def app():
    ...
    CRs and etc, It is our policy to make sure Mwanachuo facilitate the spread of authentic information and up-to-date.''')
    ...
    information and making sure user stay updates with the latest news and updates.
    ''')
